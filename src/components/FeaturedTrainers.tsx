    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <CardContent className="p-0">
                ...
                <div className="relative p-6 pb-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-semibold text-techblue-600">{trainer.company}</p>
                    </div>
                  </div>
                ...
                <div className="px-6 pb-6">
                  <Button className="w-full bg-techblue-600 hover:bg-techblue-700 text-white font-semibold py-2.5 transition-all duration-300 transform group-hover:scale-105">
                    View Profile
                  </Button>
                </div>
              </CardContent>
        ...
        <div className="text-center mt-12">
          <Button size="lg" variant="outline" className="px-8 py-3 font-semibold border-techblue-600 text-techblue-600 hover:bg-techblue-600 hover:text-white transition-all duration-300">
            View All Trainers
          </Button>
        </div>
      </div>
