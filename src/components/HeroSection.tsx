...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[80vh] bg-gradient-to-br from-techblue-50 via-purple-50 to-pink-50 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Find Expert <span className="text-gradient">IT Trainers</span><br />
            for Your Team
          </h1>
        ...
        <Card className="max-w-4xl mx-auto p-6 shadow-2xl bg-white/95 backdrop-blur-sm animate-scale-in glow-effect">
          ...
          <div className="mt-6 flex justify-center">
            <Button size="lg" className="px-12 py-3 bg-gradient-to-r from-techblue-600 to-purple-600 hover:from-techblue-700 hover:to-purple-700 text-white font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 animate-fade-in">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-techblue-600 mb-2">2,500+</div>
            <div className="text-gray-600">Expert Trainers</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-techblue-600 mb-2">50+</div>
            <div className="text-gray-600">Technologies</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-techblue-600 mb-2">98%</div>
            <div className="text-gray-600">Success Rate</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-techblue-600 mb-2">24/7</div>
