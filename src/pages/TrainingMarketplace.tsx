            ...
            <div className="space-y-6">
              {isLoading ? (
                ...
                filteredRequests?.map((request) => (
                  <Card key={request.id} className="border-l-4 border-l-techblue-500 hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        >
                          ...
                          {user ? 'View & Apply' : 'Login to Apply'}
                        </Button>
                      </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        ...
                        {request.language_preference && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">{request.language_preference}</span>
                          </div>
                        )}
                      </div>
