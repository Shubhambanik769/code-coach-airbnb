      ...
      <section className="section-padding bg-background">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            <Card className="group card-soft hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-blue-50 to-primary-50 overflow-hidden">
              <CardContent className="p-10">
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <div>
                    <h3 className="heading-md text-foreground">For Expert Trainers</h3>
                    <p className="text-muted-foreground body-md">Share your expertise and earn</p>
                  </div>
                </div>
                
                <ul className="space-y-6 text-foreground mb-10">
                  {[
            ...
            <Card className="group card-soft hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br from-accent to-muted overflow-hidden">
              <CardContent className="p-10">
                <div className="flex items-center gap-6 mb-8">
                  <div className="bg-primary p-5 rounded-3xl shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                    <Users className="h-8 w-8 text-white" />
                  </div>
                  <div>
                    <h3 className="heading-md text-foreground">For Organizations</h3>
                    <p className="text-muted-foreground body-md">Find the perfect training partner</p>
                  </div>
                </div>
